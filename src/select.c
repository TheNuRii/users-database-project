...
int main() {
    ...
    while (1) {
        ...
        // Add teh listenig socket to teh read set
        ...
        // Wait for an activiety on one of the sockets
        ...
        if (FD_ISSET(listen_fd, &read_fds)) {
            ...
            // Find a free slot for teh new connection
